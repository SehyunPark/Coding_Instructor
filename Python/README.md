...
| Python Basics | • Python Fundamentals (3 Weeks) <br> • if <br> • for + list <br> • while + dictionary + tuple <br> • function <br> • 100 exercises I (3 weeks) <br> • Try-Except Block & Top Errors <br> • Regular Expressions <br>  | TBD | ⭐⭐⭐ |
